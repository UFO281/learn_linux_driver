...
# if 1 /*key_use*/
    ...
    if (key.major) /*申请了设备号*/
    {
         ...
         */
        register_chrdev_region(key.devid,KEY_CNT,KEY_Name);/*注册设备号*/
    }
    else
    {
    ...
    /*3. 添加一个 char_dev*/
    cdev_add(&key.char_dev,key.devid,KEY_CNT);
    ...
    /*5. 创建设备*/
    key.devices = device_create(key.class,NULL,key.devid,NULL,KEY_Name);
